...
#
# AUTHOR: theprimeagen --- this is a modified version of https://github.com/ThePrimeagen/.dotfiles/blob/master/bin/.local/scripts/tmux-sessionizer
# DATE: Feb 10, 2023
...
if [[ $# -eq 1 ]]; then
    # you can pass the directory directly, see `~/.config/tmux/tmux.conf`
    working_directory=$1
else
