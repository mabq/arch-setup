...
opt.sidescroll = 8 -- minimum number of columns to scroll horizontal
opt.number = true -- print the line number in front of each line
opt.relativenumber = true -- show relative line number in front of each lmne
opt.list = true -- show <Tab> and <EOL>
opt.listchars = { nbsp = " ", tab = "󰇙 ", trail = "·" } -- characters for displaying in list mode
...
opt.hidden = true -- don't unload buffer when it is |abandon|ed
...
opt.nrformats = 'alpha' -- number formats recognized for CTRL-A / CTRL-X commands
