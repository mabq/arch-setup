-- List of LSP servers to install and configure, see notes at the bottom
local servers = {
  lua_ls = {
    settings = {
      Lua = {
        diagnostics = {
          globals = { 'vim' }, -- fix undefined global vim, see https://luals.github.io/wiki/settings/#diagnosticsglobals
        },
      },
    },
  },
  bashls = {},
  -- ts_ls = {}, -- replaced wtih typescript-tools, see below
}
...
return {
  -- Install external tools with Mason
  {
