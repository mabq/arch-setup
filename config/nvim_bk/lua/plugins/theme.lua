		...
		config = function()
			require("tokyonight").setup({
				...
				on_highlights = function(hl, c)
					hl.CursorLine.bg = "#23232f" -- toggle manually `:set cursorLine!`
					hl.CursorColumn.bg = "#23232f" -- toggle manually `set cursorColumn!`
					hl.ColorColumn.bg = "#23232f" -- toggle manually `:set colorColumn=[col]`
				end,
			})
